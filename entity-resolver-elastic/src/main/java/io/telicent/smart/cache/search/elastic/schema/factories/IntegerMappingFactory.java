...
/**
 * An ElasticSearch mapping factory for {@link CommonFieldTypes#INTEGER} mapping rules
 */
public class IntegerMappingFactory extends AbstractMappingFactory {

    /**
     * Creates a new factory
     */
    public IntegerMappingFactory() {
        super(CommonFieldTypes.INTEGER, "integer");
    }
