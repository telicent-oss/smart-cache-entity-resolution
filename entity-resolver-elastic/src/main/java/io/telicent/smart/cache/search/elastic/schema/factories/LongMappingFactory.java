...
/**
 * An ElasticSearch mapping factory for {@link CommonFieldTypes#LONG} mapping rules
 */
public class LongMappingFactory extends AbstractMappingFactory {

    /**
     * Creates a new factory
     */
    public LongMappingFactory() {
        super(CommonFieldTypes.LONG, "long");
    }

    @Override
    public Property toProperty(IndexMappingRule rule) {
        return Property.of(p -> p.long_(f -> f.index(true)));
    }
}
