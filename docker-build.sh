...
#
# Script that builds docker images for use and testing.
#
...
buildAndPushImage "smart-cache-entity-resolution-api"
buildAndPushImage "smart-cache-elastic-can-index"
