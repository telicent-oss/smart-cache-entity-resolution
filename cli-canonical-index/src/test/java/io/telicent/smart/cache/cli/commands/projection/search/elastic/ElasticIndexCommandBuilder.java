...
import io.telicent.smart.cache.cli.commands.projection.search.elastic.canonical.CanonicalIndexCommand;
 ...
 */
public class ElasticIndexCommandBuilder {
     ...
     */
    public ElasticIndexCommandBuilder() {
    ...
    public ElasticIndexCommandBuilder(KafkaTestCluster kafka, AbstractSearchCluster elastic) {
        this();
        if (kafka != null) {
            CollectionUtils.addAll(this.arguments,
                                   "--bootstrap-server",
     ...
     * @return Builder
     */
    public ElasticIndexCommandBuilder argument(String argument) {
     ...
     * @return Builder
     */
    public ElasticIndexCommandBuilder arguments(String... arguments) {
